...
class HallSensor: public Sensor{
 public:
	...
	@param linear  boolean to activate digital hall simulation for linear hall sensors.
	@param thA  threshold for "high" state of linear hall sensor A
	@param thB  threshold for "high" state of linear hall sensor B
	@param thC  threshold for "high" state of linear hall sensor C
    */
    HallSensor(int encA, int encB, int encC, int pp, bool linear, int thA, int thB, int thC);
